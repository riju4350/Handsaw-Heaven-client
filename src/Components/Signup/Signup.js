  ...
  return (
    <div className='flex justify-center items-center h-screen my-12'>
        ...
        {signUpError}
          ...
          <input type="submit" className='btn btn-primary w-full max-w-xs my-5 font-bold' value="signup"/>
         </form>
         <p className='text-center'><small className='font-bold'>Already An Account? <Link to="/login" className='text-orange-500'> Please Login</Link> </small></p>
